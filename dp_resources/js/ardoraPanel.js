...
if (doneA[i] == "0") {contexto.beginPath();contexto.fillStyle=colorSele;contexto.arc(parseInt(panelWords(coorx[i])),parseInt(panelWords(coory[i])),6,0,2*Math.PI,false);contexto.fill();contexto.strokeStyle=colorButton;contexto.lineWidth = 2;contexto.stroke();} else {
contexto.beginPath();contexto.fillStyle=colorButton;contexto.arc(parseInt(panelWords(coorx[i])), parseInt(panelWords(coory[i])), 6, 0, 2 * Math.PI, false);contexto.fill();contexto.strokeStyle = colorSele;contexto.lineWidth = 2;
...
contexto.beginPath();contexto.fillStyle =colorB;contexto.arc(parseInt(panelWords(coorx[texSel])),parseInt(panelWords(coory[texSel])),7, 0 , 2 * Math.PI, false);
